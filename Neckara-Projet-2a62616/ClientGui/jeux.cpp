...
namespace LD
{
    ...
    Jeux::Jeux(irr::u32 x, irr::u32 y, const wchar_t * titre) :
        ...
        x(x),
        y(y),
        device(irr::createDevice(irr::video::EDT_OPENGL, irr::core::dimension2d<irr::u32>(x,y), 32, false, true, true, 0) ),
        ...
        sommaire(new Sommaire(this) )
    {
        ...
        gui->getSkin()->setFont(gui->getFont("ressources/fontlucida.png"));
    }
